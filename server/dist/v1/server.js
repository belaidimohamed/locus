...
dotenv_1.default.config({ path: posix_1.default.resolve(__dirname, "./config/.env") });
...
if (cluster_1.default.isPrimary) {
    ...
    const server = net_1.default.createServer({ pauseOnConnect: true }, (connection) => {
        ...
        let worker = workers[(0, utils_1.getWorkerIdx)(ip, processesNum)];
    ...
    io.on("connection", socket => {
        ...
        logger_1.logger.info(`connected to worker: ${workerId}`);
    });
